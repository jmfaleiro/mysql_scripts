...
def parse_args():
  ...
  return args.master, args.logfile, args.logpos, args.debug
...
def setup_slave(master, logfile, logpos, debug):
  if debug:
...
def main():
  master, logfile, logpos, debug = parse_args()
  setup_slave(master, logfile, logpos, debug)
